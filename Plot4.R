...
datasub<-transform(datasub, Global_reactive_power=as.numeric(Global_reactive_power), Voltage=as.numeric(Voltage), Global_active_power=as.numeric(Global_active_power), Sub_metering_1=as.numeric(Sub_metering_1), Sub_metering_2=as.numeric(Sub_metering_2), Sub_metering_3=as.numeric(Sub_metering_3))
...
plot(datasub$datetime, datasub$Voltage, type="l", xlab="", ylab="Voltage")
...
plot(datasub$datetime, datasub$Global_reactive_power, type="l", xlab="", ylab="Global Reactive Power")
